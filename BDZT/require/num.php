...
$sql = "SELECT count(*) as bd FROM tdd WHERE nf = '".$year."' AND kslx = '对口升学' AND sfbd = '1'";
$rs = $db->query($sql);
$ninfo1 = $rs->fetch(PDO::FETCH_ASSOC);

$sql = "SELECT count(*) as wbd FROM tdd WHERE nf = '".$year."' AND kslx = '对口升学' AND sfbd = '0'";
$rs = $db->query($sql);
$ninfo12 = $rs->fetch(PDO::FETCH_ASSOC);

$sql = "SELECT count(*) as bd FROM tdd WHERE nf = '".$year."' AND kslx = '普通高考' AND sfbd = '1'";
$rs = $db->query($sql);
$ninfo2 = $rs->fetch(PDO::FETCH_ASSOC);

$sql = "SELECT count(*) as wbd FROM tdd WHERE nf = '".$year."' AND kslx = '普通高考' AND sfbd = '0'";
$rs = $db->query($sql);
$ninfo22 = $rs->fetch(PDO::FETCH_ASSOC);

$sql = "SELECT count(*) as bd FROM tdd WHERE nf = '".$year."' AND kslx = '专升本' AND sfbd = '1'";
$rs = $db->query($sql);
$ninfo3 = $rs->fetch(PDO::FETCH_ASSOC);

$sql = "SELECT count(*) as wbd FROM tdd WHERE nf = '".$year."' AND kslx = '专升本' AND sfbd = '0'";
$rs = $db->query($sql);
