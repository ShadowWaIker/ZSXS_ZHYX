...
define ("MySqlDSN_lqcxk","mysql:host=数据库1IP;port=数据库1端口;dbname=数据库1实例名;charset=utf8");
define ("MySqlDSN_DataCenter","mysql:host=数据库2IP;port=数据库2端口;dbname=数据库2实例名;charset=utf8");
define ("MySqlDSN_WeChat","mysql:host=数据库3IP;port=数据库3端口;dbname=数据库3实例名;charset=utf8");
